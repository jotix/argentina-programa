...
#+RESULTS:
: Claves: dict_keys(['uno', 'dos', 'tres', 'cuatro', 'cinco'])
...
while ingreso_flag:
    ...
    if dni != -1:
        ...
        persona["domicilio"] = input("Ingrese domicilio: ")
...
print(lista[lista_dnis.index(dni)] if dni in lista_dnis else f"el dni {dni} no está entre los datos ingresados.")
#+end_src
