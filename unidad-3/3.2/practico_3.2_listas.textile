h1=. Práctico Nro. 3.2: Tipos de Dato Colección - Listas

Juan José Della Vecchia
...
bc.   l = [10,"hola",2.5,20,"que",3.5,30,"tal",4.5]
  print (l[6])
  print (l[2])
  print (l[:3])
...
bc.   s = input("Ingrese una lista de dos elementos separados por comas (ej. 1,2):")
  lista = s.split(",")
  a = lista[0]
  b = lista[1]
...
bc.   a = input("Ingrese el elemento a: ")
...
bc.   a = int(input("Ingrese un número entero: "))
...
bc.   ingreso = input("Ingrese una lista, separe los elementos con comas: ")
  lista = list(map(lambda elem: int(elem), ingreso.split(",")))
  lista.sort()
  menor = lista[0]
...
bc.   s = input("Ingrese una lista, separe los elementos con comas: ")
  l = s.split(",")
